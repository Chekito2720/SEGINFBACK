...
//
export const registroSchema: FastifySchema = {
  body: {
    type: 'object',
...
// ─── Obtener perfil ───────────────────────────────────────────────────────────
export const getPerfilSchema: FastifySchema = {
  params: {
    type: 'object',
    required: ['id'],
    properties: {
...
// ─── Actualizar perfil ────────────────────────────────────────────────────────
export const updatePerfilSchema: FastifySchema = {
  params: {
    type: 'object',
    required: ['id'],
    properties: {
...
export const updatePermisosSchema: FastifySchema = {
  params: {
    type: 'object',
    required: ['id'],
    properties: {
